        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className={`lg:col-span-2 space-y-8 transition-all duration-700 delay-100 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <a href="tel:+919845572653" className="text-lg text-[#111] font-bold hover:text-[#25D366] transition-colors">+91 98455 72653</a>
                    </div>
                  </div>
            ...
            <div className="bg-gray-200 rounded-3xl h-64 overflow-hidden border border-black/5 shadow-sm relative group">
                <iframe 
                src="https://maps.google.com/maps?q=1st+Main+Rd,+Sharada+Colony,+BEML+Layout,+Kamakshipalya,+Bengaluru+560079&output=embed" 
            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 border border-black/5 shadow-xl">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <a href="https://wa.me/919845572653" target="_blank" rel="noopener noreferrer" className="flex-1 bg-[#25D366] hover:bg-[#20bd5a] text-white py-4 rounded-xl text-[15px] font-bold flex items-center justify-center gap-2 transition-colors shadow-[0_10px_20px_rgba(37,211,102,0.2)]">
